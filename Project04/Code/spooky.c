...
//
static inline void mix(const uint64_t *data, uint64_t *s0, uint64_t *s1,
                       uint64_t *s2, uint64_t *s3, uint64_t *s4, uint64_t *s5,
                       uint64_t *s6, uint64_t *s7, uint64_t *s8, uint64_t *s9,
...
//
static inline void endPartial(uint64_t *h0, uint64_t *h1, uint64_t *h2,
                              uint64_t *h3, uint64_t *h4, uint64_t *h5,
                              uint64_t *h6, uint64_t *h7, uint64_t *h8,
...
static inline void end(const uint64_t *data, uint64_t *h0, uint64_t *h1,
                       uint64_t *h2, uint64_t *h3, uint64_t *h4, uint64_t *h5,
                       uint64_t *h6, uint64_t *h7, uint64_t *h8, uint64_t *h9,
...
//
static inline void short_end(uint64_t *h0, uint64_t *h1, uint64_t *h2,
                             uint64_t *h3) {
  *h3 ^= *h2;
  *h2 = rot64(*h2, 15);
  *h3 += *h2;
...
//
void spooky_shorthash(const void *message, size_t length, uint64_t *hash1,
                      uint64_t *hash2) {
...
void spooky_update(struct spooky_state *state, const void *message,
  ...
  if (state->m_remainder) {
    ...
    mix(&u.p64[SC_NUMVARS], &h0, &h1, &h2, &h3, &h4, &h5, &h6, &h7, &h8, &h9,
        &h10, &h11);
...
void spooky_final(struct spooky_state *state, uint64_t *hash1,
                  uint64_t *hash2) {
  uint64_t h0, h1, h2, h3, h4, h5, h6, h7, h8, h9, h10, h11;
